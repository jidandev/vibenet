    ...
    return (
        <div ref={mainDivRef} className="bg-white dark:bg-black h-screen relative overflow-y-auto w-full px-0 sm:px-20 lg:px-0 flex flex-col">
            ...
            {openComment && (
                ...
                className="fixed top-0 left-0 lg:left-auto h-screen bg-white dark:bg-black z-50 p-6 overflow-y-auto"
                >
                    <div className="w-full h-12 bg-white dark:bg-black flex -mt-3">
                    ...
                    <div style={{ width }} className="fixed  bottom-0 left-0 sm:left-0 lg:left-auto px-2  bg-white dark:bg-black flex flex-col">
                        {commentData !== null && (
                            <div className="flex">
